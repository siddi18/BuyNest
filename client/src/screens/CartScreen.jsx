...
export default function CartScreen() {
    ...
    const checkoutHandler = () => {
        if (userInfo) {
            ...
            // If not logged in, go to login with redirect parameter
                        ...
                        {cartItems.map(item => (
                            ...
                            >
                                <div>
                                    ...
                                    <button className="bg-red-600 text-white px-4 py-2 rounded-md mt-4 hover:text-gray-200" onClick={() => handleDeleteItem(item._id)}>Remove</button>
                                </div>
                            </div>
                        ))}
                    </div> : (
