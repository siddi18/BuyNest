...
//     const { data: userOrders, isLoading, error } = useGetUserOrdersQuery(userInfo._id)
...
export default function ProfileScreen() {
    ...
    return (
        <div className="flex flex-col sm:flex-row gap-4 p-4">
            {/* Profile Section */}
            <div className="w-full sm:w-1/4 p-4 bg-white shadow-md rounded-lg">
                <h1 className="text-xl font-semibold mb-4">Profile</h1>
                <form className="mb-6" onSubmit={handleUpdateProfile}>
                    <div className="mb-4">
                        <label htmlFor="name" className="block text-sm font-medium text-gray-700">
            ...
            {/* Orders Section */}
            <div className="w-full sm:w-3/4 p-4 bg-white shadow-md rounded-lg">
                <h2 className="text-xl font-semibold mb-4">Your Orders</h2>
